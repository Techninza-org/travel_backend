    ...
    try{
        ...
        if (data && !data.error) {
            ...
            if (data.isCancelled === true) {
                ...
                console.log(`[${requestId}] FLIGHT CANCELLATION SUCCESS - Booking cancelled successfully`);
            }else{
                console.warn(`[${requestId}] FLIGHT CANCELLATION WARNING - Booking cancellation failed`);
            }
        } else {
